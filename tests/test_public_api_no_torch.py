...
"""Frozen ParaScale 0.1 public API tests without Torch."""
...
def test_public_api_matches_v0_1_snapshot():
    snapshot = Path(__file__).with_name("public_api_v0_1.txt")
...
def test_config_schema_contract_is_public():
    assert parascale.PUBLIC_API_VERSION == "0.1"
